...
parser.add_argument('--data_name',type=str,default='csxd_data/dh_csxd_train',help='training data in csv format')
parser.add_argument('--test_name',type=str,default='csxd_data/dh_csxd_test',help='training data in csv format')
