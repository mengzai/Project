...
class Plot_KS_ROC():
    ...
    def plot_roc(self):
        ...
        plt.plot(fpr, tpr, 'r-', linewidth=2.0, aa=False, label='ROC (area=%0.6f)' % (auc))
...
plot_object=Plot_KS_ROC(y,pred,'/Users/wanglili/Documents/workstation/working/fenxian_model/lr_new/roc_ks')
