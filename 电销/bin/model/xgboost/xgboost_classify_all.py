...
model_features = ['label', 'phone', 'call_times', 'connect_times', 'has_callin', 'has_staff_hangup', 'avg_waittime',
                  ...
                  'jietong_midu_10','duration_midu_10', 'jietong_midu_20','duration_midu_20',
                  ...
                  ##delete  ,'call_midu_10', 'city_low50','call_midu_5','jietong_midu_5',
                  ##
...
def main():
    ...
    param['learning_rate'] = 0.54  # 0.05-1
    param['objective'] = 'binary:logistic'  ######目标函数,可以自己写一个函数
    # param['subsample'] = 0.7
    # param['colsample_bytree'] = 0.5  # 0.9
    param['nthread'] = 8
    param['silent'] = 0
