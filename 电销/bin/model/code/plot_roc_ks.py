...
class Plot_KS_ROC():
    ...
    def plot_roc(self):
        ...
        plt.savefig('%s/roc_curve_v2.png' % (self.save_path), dpi=180)
    ...
    def plot_ks(self):
        ...
        print "ks:", max_ks_gap_value,xytext_value
        ...
        plt.show()
        fig.savefig('%s/ks_curve_v2.png' % (self.save_path), dpi=180)
...
# y2=[0]*120000
# y=flatten([y1,y2])
# plot_object=Plot_KS_ROC(y,pred,'/Users/yangsu/Documents/python/odds')
...
label=load_data('total_data/dianxiao_10')['label']
file=open("ML/GBM/LightGBM_predict_result.txt")
groud_truth=[]
y_pred=[]

for line in file.readlines():
	line=line.strip('\n')
	y_pred.append(float(line))

plot_object=Plot_KS_ROC(list(label),y_pred,"ML/GBM/")
plot_object.plot_roc()
plot_object.plot_ks()
