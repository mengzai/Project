create table dianxiao_bad_feature_7_v2
as
...
select *
from
ods.newdxwh_callhistory callhis
where callhis.calltime>='2016-07-01' and callhis.calltime<='2016-07-31'
and  callhis.customerid is not null and  callhis.customerid not in (select b.customer_guid as id from dianxiao_label_onlineyrd_tmp b)
) tmp1
join
(
