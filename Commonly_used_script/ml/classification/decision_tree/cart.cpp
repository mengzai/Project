...
//-------------------------------------------------------------------------------------------------
void CART::TrainClassifier(int n, int d, float *X, int *y, float *z)
{
	// check criteria
...
//-------------------------------------------------------------------------------------------------
void CART::TrainRegressor(int n, int d, float *X, float *y, float *z)
{
	// check criteria
	if(criteria<CART_R_MEAN_SQUARED_ERROR)
	{
...
//-------------------------------------------------------------------------------------------------
int CART::TestClassifier(int n, float *X, int *y, float *z)
{
...
//-------------------------------------------------------------------------------------------------
float CART::TestRegressor(int n, float *X, float *y, float *z) // return mean_abs_err
{
	if(cart==0){ printf("error: there is no any model\n"); return 0; }
