...
int main(int argn, const char *argv[])
{
	...
	if(!check)
	{
		printf("Usage: train_lr trainfile [weights] option lambda model verbose\n");
		...
		printf("       option    - 0:LR, 1:L1-LR, 2:L2-LR, 3:LR+, 4:L2-LR+\n");
		printf("       verbose   - 0:silent; 1:print progress messages\n");
		printf("       e.g. train_lr train.txt 2 0.001 model.lr 1\n");
		printf("       e.g. train_lr train.txt 3.0 2 0.001 model.lr 1\n");
