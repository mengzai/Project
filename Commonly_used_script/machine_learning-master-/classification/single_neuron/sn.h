...
public:
	...
	bool TrainModel(int num, int dim, float *X, int *y, int reg, float lam, float *wb = 0);
	bool TrainModelNNW(int num, int dim, float *X, int *y, int reg, float lam, float *wb = 0);
