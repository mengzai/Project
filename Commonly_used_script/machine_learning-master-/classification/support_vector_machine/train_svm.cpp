...
int main(int argn, const char *argv[])
{
	...
	if(!check)
	{
		printf("Usage: train_svm train_file option(0:Hinge by FSMO; 1:Huber-Hinge by LBFGS; 2:Square-Hinge by LBFGS; 3:SVM+ by L-BFGS-B) c model\n");
		printf("       e.g. train_svm train.txt 0 1.0 model.svm\n");
		return 0;
	}
