...
public:
	...
	void TrainClassifier(int n, int d, float *X, int *y);
	int  TestClassifier(int n, float *X, int *y); // return error number

	void TrainRegressor(int n, int d, float *X, float *y);
	float TestRegressor(int n, float *X, float *y); // return mean_abs_err
